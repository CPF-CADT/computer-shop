...
describe('Address Controller - Unit Tests', () => {
    ...
    describe('addCustomerAddress', () => {
        it('should add an address and call res.status(201)', async () => {
            mockRequest.body = {
                customer_id: '1',
    ...
    describe('getCustomerAddresses', () => {
        it('should get addresses for a customer and call res.status(200)', async () => {
    ...
    describe('updateCustomerAddress', () => {
        it('should update an address and call res.status(200)', async () => {
    ...
    describe('deleteCustomerAddress', () => {
        it('should delete an address and call res.status(200)', async () => {
            mockRequest.params = { address_id: '1' };
        ...
        it('should return 404 if address to delete is not found', async () => {
            mockRequest.params = { address_id: '999' };
