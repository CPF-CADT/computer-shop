...
export default function Nav() {
  ...
  const handleSearchSubmit = (e) => {
    ...
    if (foundBrand) {
      const canonicalBrand = brands.find(
        (b) => b.name.toLowerCase() === foundBrand
      )?.name;
      queryParams.set("brand", canonicalBrand || foundBrand);
    }
    if (foundTypeProduct) {
      const canonicalTypeProduct = typeProducts.find(
        (t) => t.title.toLowerCase() === foundTypeProduct
      )?.title;
              ...
              >
                <img
                  src={
                    ...
                    "https://res.cloudinary.com/dokut37k6/image/upload/v1752849581/145857007_307ce493-b254-4b2d-8ba4-d12c080d6651_zppdms.svg"
                  }
